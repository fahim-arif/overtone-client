...
class ProductDetail extends Component {
    ...
    render() {
        console.log(this.state.imgAttribute)
                                        ...
                                        <div className="col-md-6">
                                            <div className="ac-container">
                                                ...
                                                <div className="price-bar">
                                                    ...
                                                    <div className="cart_itemcount-detail">
                                                        <ul>
                                                            <li onClick={() => this.decreaseQuantity(productData)}><i className="fa fa-minus" aria-hidden="true" /></li>
                                                            <li><input value={this.state.quantity} type="number" id="quantity" name="quantity" min={1} /> </li>
                                                            <li onClick={() => this.increaseQuantitiy(productData)}><i className="fa fa-plus" aria-hidden="true" /></li>
