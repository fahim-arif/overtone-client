              ...
              <div className="col-md-12">
                <div id="login-column">
                  <div id="login-box" className="col-md-12">
                    ...
                    <small class="text-dark">Enter the email address or mobile phone number associated with your Overtone account.</small>
                    <form  id="login-form" className="form" className="kt-form"  onSubmit={this.onSubmitLogin}>
                    <div className="form-group">
                     <label htmlFor="username" className="text-info">Email or mobile phone number </label>
